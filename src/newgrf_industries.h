...
struct IndustriesResolverObject : public ResolverObject {
	...
	IndustriesResolverObject(
		TileIndex tile, Industry *indus, IndustryType type, uint32_t random_bits = 0, CallbackID callback = CBID_NO_CALLBACK, uint32_t callback_param1 = 0, uint32_t callback_param2 = 0);
