...
private:
	...
	uint ComputeGroupInfoSize()
	{
		...
		this->column_size[VGC_NAME] = maxdim(GetStringBoundingBox(STR_GROUP_DEFAULT_TRAINS + std::to_underlying(this->vli.vtype)), GetStringBoundingBox(STR_GROUP_ALL_TRAINS + std::to_underlying(this->vli.vtype)));
	...
	{
		if (IsAllGroupID(g_id)) return GetString(STR_GROUP_ALL_TRAINS + std::to_underlying(this->vli.vtype));
		if (IsDefaultGroupID(g_id)) return GetString(STR_GROUP_DEFAULT_TRAINS + std::to_underlying(this->vli.vtype));
...
public:
	VehicleGroupWindow(WindowDesc &desc, WindowNumber window_number, const VehicleListIdentifier &vli) : BaseVehicleListWindow(desc, vli)
	{
		...
		this->GetWidget<NWidgetCore>(WID_GL_CAPTION)->SetString(STR_VEHICLE_LIST_TRAIN_CAPTION + std::to_underlying(this->vli.vtype));
		this->GetWidget<NWidgetCore>(WID_GL_LIST_VEHICLE)->SetToolTip(STR_VEHICLE_LIST_TRAIN_LIST_TOOLTIP + std::to_underlying(this->vli.vtype));

		this->GetWidget<NWidgetCore>(WID_GL_CREATE_GROUP)->SetSprite(SPR_GROUP_CREATE_TRAIN + std::to_underlying(this->vli.vtype));
		this->GetWidget<NWidgetCore>(WID_GL_RENAME_GROUP)->SetSprite(SPR_GROUP_RENAME_TRAIN + std::to_underlying(this->vli.vtype));
		this->GetWidget<NWidgetCore>(WID_GL_DELETE_GROUP)->SetSprite(SPR_GROUP_DELETE_TRAIN + std::to_underlying(this->vli.vtype));
		this->GetWidget<NWidgetCore>(WID_GL_LIVERY_GROUP)->SetSprite(SPR_GROUP_LIVERY_TRAIN + std::to_underlying(this->vli.vtype));
		this->GetWidget<NWidgetCore>(WID_GL_REPLACE_PROTECTION)->SetSprite(SPR_GROUP_REPLACE_OFF_TRAIN + std::to_underlying(this->vli.vtype));
	...
	void OnPaint() override
	{
		...
		this->GetWidget<NWidgetCore>(WID_GL_REPLACE_PROTECTION)->SetSprite(protect_sprite + std::to_underlying(this->vli.vtype));
...
static void ShowCompanyGroupInternal(CompanyID company, VehicleType vehicle_type, GroupID group)
{
	...
	assert(std::to_underlying(vehicle_type) < std::size(_vehicle_group_desc));
