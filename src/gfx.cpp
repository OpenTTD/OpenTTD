...
/**
 * Include the specified rectangle into the collection of invalid screen rectangles, splitting as required.
 *
 * This is an implementation detail of \c SetDirtyBlocks, and should be treated as such.
 *
 * @param start the position in the dirty block collection from which to start splitting.
