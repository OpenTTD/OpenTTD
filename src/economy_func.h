...
extern const EnumClassArray<ScoreInfo, ScoreID, ScoreID::End> _score_info;
extern TypedIndexContainer<std::array<EnumClassArray<int64_t, ScoreID, ScoreID::End>, MAX_COMPANIES>, CompanyID> _score_part;
