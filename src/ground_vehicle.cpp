...
bool GroundVehicle<T, Type>::IsChainInDepot() const
{
	...
	static_assert(std::to_underlying(TransportType::Rail) == std::to_underlying(VehicleType::Train));
	static_assert(std::to_underlying(TransportType::Road) == std::to_underlying(VehicleType::Road));
