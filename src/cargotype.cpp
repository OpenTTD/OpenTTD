...
ReferenceThroughBaseContainer<std::array<CargoSpec, NUM_CARGO>> CargoSpec::array{};
...
ReferenceThroughBaseContainer<std::array<uint8_t, NUM_CARGO>> _sorted_cargo_types; ///< Sort order of cargoes by cargo type.
