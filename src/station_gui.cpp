...
static constexpr std::initializer_list<NWidgetPart> _nested_station_view_widgets = {
	...
	NWidget(NWID_HORIZONTAL, NWidContainerFlag::EqualSize),
		...
		NWidget(WWT_PUSHTXTBTN, Colours::Grey, WID_SV_GRAPH), SetResize(1, 0), SetFill(1, 0), SetStringTip(STR_INDUSTRY_VIEW_CARGO_GRAPH, STR_INDUSTRY_VIEW_CARGO_GRAPH_TOOLTIP),
