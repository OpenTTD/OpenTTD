...
{
	return fmt::format("{} ({})", std::to_underlying(td), ItemAtT(td, trackdir_names, "UNK", INVALID_TRACKDIR, "INV"));
}

/** Return composed name of given TrackdirBits. */
std::string ValueStr(TrackdirBits td_bits)
{
	return fmt::format("{} ({})", std::to_underlying(td_bits), ComposeNameT(td_bits, trackdir_names, "UNK", INVALID_TRACKDIR_BIT, "INV"));
}
...
{
	return fmt::format("{} ({})", std::to_underlying(dd), ItemAtT(dd, diagdir_names, "UNK", INVALID_DIAGDIR, "INV"));
}
...
{
	return fmt::format("{} ({})", std::to_underlying(t), ItemAtT(t, signal_type_names, "UNK"));
}
