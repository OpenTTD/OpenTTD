...
void InvalidateWindowData(WindowClass cls, WindowNumber number, T data, bool gui_scope = false) { InvalidateWindowData(cls, number, std::to_underlying(data), gui_scope); }
...
/** @copydoc InvalidateWindowClassesData */
template <typename T> requires is_scoped_enum_v<T>
void InvalidateWindowClassesData(WindowClass cls, T data, bool gui_scope = false) { InvalidateWindowClassesData(cls, std::to_underlying(data), gui_scope); }
