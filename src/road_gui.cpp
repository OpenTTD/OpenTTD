...
DropDownList RoadTypeDropdownWindowBase::GetDropDownList(const BadgeFilterChoices &badge_filter_choices, const StringFilter &string_filter) const
{
	return GetRoadTypeDropDownList(RTTB_ROAD, false, false, badge_filter_choices, string_filter);
}

DropDownList TramTypeDropdownWindowBase::GetDropDownList(const BadgeFilterChoices &badge_filter_choices, const StringFilter &string_filter) const
{
