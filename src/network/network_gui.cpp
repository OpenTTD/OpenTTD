	...
	NWidget(WWT_PANEL, COLOUR_GREY),
		...
		NWidget(NWID_HORIZONTAL),
			NWidget(NWID_VERTICAL),
				...
				NWidget(WWT_TEXT, COLOUR_GREY, WID_CL_CLIENT_COMPANY_COUNT), SetFill(1, 0), SetMinimalTextLines(1, 0), SetResize(1, 0), SetPadding(2, 1, 2, 1), SetAlignment(SA_RIGHT), SetDataTip(STR_NETWORK_CLIENT_LIST_CLIENT_COMPANY_COUNT, STR_NULL),
			EndContainer(),
			NWidget(NWID_VERTICAL),
