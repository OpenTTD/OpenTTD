 ...
 */
const EnumClassArray<ScoreInfo, ScoreID, ScoreID::End> _score_info = {
...
TypedIndexContainer<std::array<EnumClassArray<int64_t, ScoreID, ScoreID::End>, MAX_COMPANIES>, CompanyID> _score_part;
Economy _economy;
Prices _price;
