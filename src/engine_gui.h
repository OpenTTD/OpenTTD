...
void DrawEngineList(VehicleType type, const Rect &r, const GUIEngineList &eng_list, const Scrollbar &sb, EngineID selected_id, bool show_count, GroupID selected_group, const GUIBadgeClasses &badge_classes, const std::array<GUIBadgeClasses, VEH_COMPANY_END> *badge_classes_array = nullptr);
