...
void Town::UpdateVirtCoord()
{
	...
	if (this->larger_town) {
		...
		town_string_small = GetString(STR_VIEWPORT_TOWN_CITY, this->index, this->cache.population);
		...
		town_string_small = GetString(STR_TOWN_NAME, this->index, this->cache.population);
	}
