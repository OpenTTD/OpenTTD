...
struct TerraformToolbarWindow : Window {
	...
	static inline HotkeyList hotkeys{"terraform", {
		...
		Hotkey({'W' | WKC_GLOBAL_HOTKEY, WKC_SHIFT | 'W' | WKC_GLOBAL_HOTKEY}, "raise", WID_TT_RAISE_LAND),
		Hotkey('E' | WKC_GLOBAL_HOTKEY, "level", WID_TT_LEVEL_LAND),
		Hotkey({'D' | WKC_GLOBAL_HOTKEY, WKC_SHIFT | 'D' | WKC_GLOBAL_HOTKEY}, "dynamite", WID_TT_DEMOLISH),
...
struct ScenarioEditorLandscapeGenerationWindow : Window {
	...
	static inline HotkeyList hotkeys{"terraform_editor", {
		Hotkey({'D' | WKC_GLOBAL_HOTKEY, WKC_SHIFT | 'D' | WKC_GLOBAL_HOTKEY}, "dynamite", WID_ETT_DEMOLISH),
		Hotkey('Q' | WKC_GLOBAL_HOTKEY, "lower", WID_ETT_LOWER_LAND),
		Hotkey({'W' | WKC_GLOBAL_HOTKEY, WKC_SHIFT | 'W' | WKC_GLOBAL_HOTKEY}, "raise", WID_ETT_RAISE_LAND),
