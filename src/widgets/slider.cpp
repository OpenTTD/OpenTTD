...
void DrawSliderWidget(Rect r, int min_value, int max_value, int value, const std::map<int, StringID> &labels)
{
	...
	const RgbMColour shadow = GetColourGradient(COLOUR_GREY, 3);
	const RgbMColour fill = GetColourGradient(COLOUR_GREY, 6);
	const RgbMColour light = GetColourGradient(COLOUR_GREY, 7);
