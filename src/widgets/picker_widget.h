...
enum PickerClassWindowWidgets : WidgetID {
	...
	WID_PW_TOGGLE_SEL,   ///< Stack to hide the collection toggle.
	WID_PW_TOGGLE_SIZE,  ///< Button to show/hide the collections menu.
	WID_PW_COLEC_SEL,    ///< Selector for collection list, which can be hidden.
