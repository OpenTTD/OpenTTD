...
enum GameOptionsWidgets : WidgetID {
	...
	WID_GO_BASE_GRF_DESCRIPTION = WID_GO_BASE_GRF_TEXTFILE + std::to_underlying(TextfileType::ContentEnd), ///< Description of selected base GRF.
	...
	WID_GO_BASE_SFX_DESCRIPTION = WID_GO_BASE_SFX_TEXTFILE + std::to_underlying(TextfileType::ContentEnd), ///< Description of selected base SFX.
	...
	WID_GO_BASE_MUSIC_DESCRIPTION = WID_GO_BASE_MUSIC_TEXTFILE + std::to_underlying(TextfileType::ContentEnd), ///< Description of selected base music set.
