...
enum GenerateLandscapeWidgets {
	...
	WID_GL_CALENDAR_PROGRESS_SPEED_DOWN, ///< Decrease calendar progress speed
	WID_GL_CALENDAR_PROGRESS_SPEED_TEXT, ///< Calendar progress speed
	WID_GL_CALENDAR_PROGRESS_SPEED_UP,   ///< Increase calendar progress speed
...
enum CreateScenarioWidgets {
	...
	WID_CS_CALENDAR_PROGRESS_SPEED_DOWN, ///< Decrease calendar progress speed
	WID_CS_CALENDAR_PROGRESS_SPEED_TEXT, ///< Calendar progress speed
	WID_CS_CALENDAR_PROGRESS_SPEED_UP,   ///< Increase calendar progress speed
