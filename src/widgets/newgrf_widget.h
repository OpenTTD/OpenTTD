...
enum NewGRFStateWidgets : WidgetID {
	...
	WID_NS_SET_PARAMETERS = WID_NS_NEWGRF_TEXTFILE + std::to_underlying(TextfileType::ContentEnd), ///< Open Parameters Window for selected NewGRF for editing parameters.
