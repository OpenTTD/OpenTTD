...
struct GameOptionsWindow : Window {
	...
	void OnClick(Point pt, int widget, int click_count) override
	{
		...
		switch (widget) {
			...
			case WID_GO_BASE_MUSIC_OPEN_JUKEBOX: {
				ShowMusicWindow();
				break;
			}
	...
	NWidget(WWT_PANEL, COLOUR_GREY, WID_GO_BACKGROUND), SetPIP(6, 6, 10),
		...
		NWidget(WWT_FRAME, COLOUR_GREY), SetDataTip(STR_GAME_OPTIONS_BASE_MUSIC, STR_NULL), SetPadding(0, 10, 0, 10),
			NWidget(NWID_HORIZONTAL), SetPIP(0, 30, 7),
				...
				NWidget(WWT_PUSHIMGBTN, COLOUR_GREY, WID_GO_BASE_MUSIC_OPEN_JUKEBOX), SetMinimalSize(22, 22), SetDataTip(SPR_IMG_MUSIC, STR_TOOLBAR_TOOLTIP_SHOW_SOUND_MUSIC_WINDOW),
			EndContainer(),
