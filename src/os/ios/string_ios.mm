...
/** @file string_ios.mm Functions related to localized text support on iOS. */

#include "../../stdafx.h"
#include "../macosx/string_osx.h"
...
// iOS always has CoreText (since 3.2), so we don't need dlsym checks or HAVE_OSX_109_SDK logic for CTRunDelegate.
// We assume normal linking.
