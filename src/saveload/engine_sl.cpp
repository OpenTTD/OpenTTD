...
struct ENGNChunkHandler : ChunkHandler {
	ENGNChunkHandler() : ChunkHandler(LabelToNum("ENGN"), ChunkType::Table) {}
...
struct ENGSChunkHandler : ChunkHandler {
	ENGSChunkHandler() : ChunkHandler(LabelToNum("ENGS"), ChunkType::ReadOnly) {}
...
struct EIDSChunkHandler : ChunkHandler {
	EIDSChunkHandler() : ChunkHandler(LabelToNum("EIDS"), ChunkType::Table) {}
