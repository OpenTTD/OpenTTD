...
struct MAPSChunkHandler : ChunkHandler {
	MAPSChunkHandler() : ChunkHandler(LabelToNum("MAPS"), ChunkType::Table) {}
...
struct MAPTChunkHandler : ChunkHandler {
	MAPTChunkHandler() : ChunkHandler(LabelToNum("MAPT"), ChunkType::Riff) {}
...
struct MAPHChunkHandler : ChunkHandler {
	MAPHChunkHandler() : ChunkHandler(LabelToNum("MAPH"), ChunkType::Riff) {}
...
struct MAPOChunkHandler : ChunkHandler {
	MAPOChunkHandler() : ChunkHandler(LabelToNum("MAPO"), ChunkType::Riff) {}
...
struct MAP2ChunkHandler : ChunkHandler {
	MAP2ChunkHandler() : ChunkHandler(LabelToNum("MAP2"), ChunkType::Riff) {}
...
struct M3LOChunkHandler : ChunkHandler {
	M3LOChunkHandler() : ChunkHandler(LabelToNum("M3LO"), ChunkType::Riff) {}
...
struct M3HIChunkHandler : ChunkHandler {
	M3HIChunkHandler() : ChunkHandler(LabelToNum("M3HI"), ChunkType::Riff) {}
...
struct MAP5ChunkHandler : ChunkHandler {
	MAP5ChunkHandler() : ChunkHandler(LabelToNum("MAP5"), ChunkType::Riff) {}
...
struct MAPEChunkHandler : ChunkHandler {
	MAPEChunkHandler() : ChunkHandler(LabelToNum("MAPE"), ChunkType::Riff) {}
...
struct MAP7ChunkHandler : ChunkHandler {
	MAP7ChunkHandler() : ChunkHandler(LabelToNum("MAP7"), ChunkType::Riff) {}
...
struct MAP8ChunkHandler : ChunkHandler {
	MAP8ChunkHandler() : ChunkHandler(LabelToNum("MAP8"), ChunkType::Riff) {}
