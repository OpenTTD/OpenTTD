...
static std::array<PersistentStorage::ElementType, 16> _old_st_persistent_storage;
...
public:
	inline static const SaveLoad description[] = {
		...
		SLEG_CONDARR("storage", _old_st_persistent_storage,  SLE_UINT32, 16, SLV_145, SLV_161),
