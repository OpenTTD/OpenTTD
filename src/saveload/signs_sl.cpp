...
static const SaveLoad _sign_desc[] = {
	...
	SLE_CONDVAR(Sign, text_colour, SLE_FILE_U8 | SLE_VAR_U32, SLV_SIGN_TEXT_COLOURS, SLV_CUSTOM_COMPANY_COLOURS),
	SLE_CONDVAR(Sign, text_colour, SLE_UINT32, SLV_CUSTOM_COMPANY_COLOURS, SL_MAX_VERSION),
};
