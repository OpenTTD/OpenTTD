...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_NULL(14, SLV_28, SLV_TABLE_CHUNKS),
	SLC_NULL(4, SLV_100, SLV_TABLE_CHUNKS),
	SLC_NULL(7, SLV_33, SLV_TABLE_CHUNKS),
	SLC_NULL(1, SLV_47, SLV_TABLE_CHUNKS),
	SLC_NULL(2, SLV_130, SLV_TABLE_CHUNKS),
	SLC_VAR("pf.yapf.maximum_go_to_depot_penalty"),
	SLC_NULL(2, SLV_SHIP_CURVE_PENALTY, SLV_TABLE_CHUNKS),
