...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_NULL(1, SL_MIN_VERSION, SLV_87), // pf.new_pathfinding_all
	...
	SLC_NULL(4 * 8, SL_MIN_VERSION, SLV_REMOVE_PF_SETTINGS), // NPF, x18 (18 int)
	SLC_NULL(4 * 2, SLV_100, SLV_REMOVE_PF_SETTINGS),
	SLC_NULL(4 * 4, SL_MIN_VERSION, SLV_REMOVE_PF_SETTINGS),
