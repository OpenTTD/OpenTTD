...
struct PRICChunkHandler : ChunkHandler {
	PRICChunkHandler() : ChunkHandler(LabelToNum("PRIC"), ChunkType::ReadOnly) {}
...
struct CAPRChunkHandler : ChunkHandler {
	CAPRChunkHandler() : ChunkHandler(LabelToNum("CAPR"), ChunkType::ReadOnly) {}
...
struct ECMYChunkHandler : ChunkHandler {
	ECMYChunkHandler() : ChunkHandler(LabelToNum("ECMY"), ChunkType::Table) {}
...
struct CAPYChunkHandler : ChunkHandler {
	CAPYChunkHandler() : ChunkHandler(LabelToNum("CAPY"), ChunkType::Table) {}
