...
public:
	static inline const SaveLoad description[] = {
		...
		SLE_CONDVAR(Vehicle, unitnumber, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::LargerUnitNumber),
		SLE_CONDVAR(Vehicle, unitnumber, SLE_UINT16, SaveLoadVersion::LargerUnitNumber, SaveLoadVersion::MaxVersion),
		    SLE_VAR(Vehicle, owner,                 SLE_UINT8),
		SLE_CONDVAR(Vehicle, tile, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		SLE_CONDVAR(Vehicle, tile, SLE_UINT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
		SLE_CONDVAR(Vehicle, dest_tile, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		SLE_CONDVAR(Vehicle, dest_tile, SLE_UINT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),

		SLE_CONDVAR(Vehicle, x_pos, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		SLE_CONDVAR(Vehicle, x_pos, SLE_UINT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
		SLE_CONDVAR(Vehicle, y_pos, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		SLE_CONDVAR(Vehicle, y_pos, SLE_UINT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
		SLE_CONDVAR(Vehicle, z_pos, VarFileType::U8 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::VehicleCentreAndZPos),
		...
		SLE_CONDVAR(Vehicle, last_station_visited, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::BigMap),
		...
		SLEG_CONDVAR("cargo_source", _cargo_source, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::LargerCargoSource),
		...
		SLE_CONDVAR(Vehicle, current_order.dest, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::BigMap),
		...
		SLE_CONDVAR(Vehicle, timetable_start, VarFileType::I32 | SLE_VAR_U64, SaveLoadVersion::TimetableStart, SaveLoadVersion::TimetableStartTicks),
		SLE_CONDVAR(Vehicle, timetable_start, SLE_UINT64, SaveLoadVersion::TimetableStartTicks, SaveLoadVersion::MaxVersion),

		SLE_CONDVARNAME(Vehicle, old_orders, "orders", VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MoreCargoPackets),
		...
		SLE_CONDVAR(Vehicle, age, VarFileType::U16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
		...
		SLE_CONDVAR(Vehicle, max_age, VarFileType::U16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
		SLE_CONDVAR(Vehicle, max_age, SLE_INT32, SaveLoadVersion::BigDates, SaveLoadVersion::MaxVersion),
		SLE_CONDVAR(Vehicle, date_of_last_service, VarFileType::U16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
		...
		SLE_CONDVAR(Vehicle, service_interval, VarFileType::U32 | SLE_VAR_U16, SaveLoadVersion::BigDates, SaveLoadVersion::ServiceIntervalPercent),
		...
		SLE_CONDVAR(Vehicle, build_year, VarFileType::U8 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
		...
		SLE_CONDVAR(Vehicle, vehicle_flags, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::GradualLoading, SaveLoadVersion::ServiceIntervalPercent),
		SLE_CONDVAR(Vehicle, vehicle_flags, SLE_UINT16, SaveLoadVersion::ServiceIntervalPercent, SaveLoadVersion::MaxVersion),

		SLE_CONDVAR(Vehicle, profit_this_year, VarFileType::I32 | SLE_VAR_I64, SaveLoadVersion::MinVersion, SaveLoadVersion::UnifyCurrency),
		SLE_CONDVAR(Vehicle, profit_this_year, SLE_INT64, SaveLoadVersion::UnifyCurrency, SaveLoadVersion::MaxVersion),
		SLE_CONDVAR(Vehicle, profit_last_year, VarFileType::I32 | SLE_VAR_I64, SaveLoadVersion::MinVersion, SaveLoadVersion::UnifyCurrency),
		SLE_CONDVAR(Vehicle, profit_last_year, SLE_INT64, SaveLoadVersion::UnifyCurrency, SaveLoadVersion::MaxVersion),
		SLEG_CONDVAR("cargo_feeder_share", _cargo_feeder_share, VarFileType::I32 | SLE_VAR_I64, SaveLoadVersion::FeederShare, SaveLoadVersion::UnifyCurrency),
		SLEG_CONDVAR("cargo_feeder_share", _cargo_feeder_share, SLE_INT64, SaveLoadVersion::UnifyCurrency, SaveLoadVersion::CargoPackets),
		SLE_CONDVAR(Vehicle, value, VarFileType::I32 | SLE_VAR_I64, SaveLoadVersion::MinVersion, SaveLoadVersion::UnifyCurrency),
		SLE_CONDVAR(Vehicle, value, SLE_INT64, SaveLoadVersion::UnifyCurrency, SaveLoadVersion::MaxVersion),

		SLE_CONDVAR(Vehicle, random_bits, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::VehicleCurrencyStationChanges, SaveLoadVersion::ExtendVehicleRandom),
		...
		SLE_CONDVAR(Vehicle, current_order_time, VarFileType::U32 | SLE_VAR_I32, SaveLoadVersion::Timetables, SaveLoadVersion::TimetableTicksType),
...
public:
	static inline const SaveLoad description[] = {
		 ...
		 SLE_CONDVAR(Train, flags, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::VehicleCurrencyStationChanges, SaveLoadVersion::Yapp),
...
public:
	static inline const SaveLoad description[] = {
		 ...
		 SLE_CONDVAR(Aircraft, targetairport, VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::BigMap),
...
public:
	static inline const SaveLoad description[] = {
		 ...
		 SLE_CONDVAR(Vehicle, x_pos, VarFileType::I16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		 SLE_CONDVAR(Vehicle, x_pos, SLE_INT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Vehicle, y_pos, VarFileType::I16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
		 SLE_CONDVAR(Vehicle, y_pos, SLE_INT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
		 SLE_CONDVAR(Vehicle, z_pos, VarFileType::U8 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::VehicleCentreAndZPos),
		 SLE_CONDVAR(Vehicle, z_pos, SLE_INT32, SaveLoadVersion::VehicleCentreAndZPos, SaveLoadVersion::MaxVersion),

		     SLE_VAR(Vehicle, sprite_cache.sprite_seq.seq[0].sprite, VarFileType::U16 | SLE_VAR_U32),
		     SLE_VAR(Vehicle, progress,              SLE_UINT8),
		     SLE_VAR(Vehicle, vehstatus,             SLE_UINT8),
...
public:
	static inline const SaveLoad description[] = {
		...
		SLE_CONDVAR(Vehicle, z_pos, SLE_INT32, SaveLoadVersion::VehicleCentreAndZPos, SaveLoadVersion::MaxVersion),
		    ...
		    SLE_VAR(Vehicle, owner,                 SLE_UINT8),
		    SLE_VAR(Vehicle, vehstatus,             SLE_UINT8),
		SLE_CONDVARNAME(DisasterVehicle, state, "current_order.dest", VarFileType::U8 | SLE_VAR_U16, SaveLoadVersion::MinVersion, SaveLoadVersion::BigMap),
		...
		SLE_CONDVAR(DisasterVehicle, image_override, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::LinkgraphLocationDisasterStore),
		...
		SLE_CONDVAR(DisasterVehicle, big_ufo_destroyer_target, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::LinkgraphLocationDisasterStore),
