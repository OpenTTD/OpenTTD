...
static const SaveLoad _date_desc[] = {
	...
	SLEG_CONDVAR("economy_date",           _economy_date,           SLE_INT32,                   SLV_NOCALENDAR, SL_MAX_VERSION),
	SLEG_CONDVAR("economy_date_fract",     _economy_date_fract,     SLE_UINT16,                  SLV_NOCALENDAR, SL_MAX_VERSION),
