...
static const SaveLoad _date_desc[] = {
	SLEG_CONDVAR("date", TimerGameCalendar::date, VarFileType::U16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
	...
	SLEG_CONDVAR("tick_counter", TimerGameTick::counter, VarFileType::U16 | SLE_VAR_U64, SaveLoadVersion::MinVersion, SaveLoadVersion::U64TickCounter),
	...
	SLEG_CONDVAR("cur_tileloop_tile", _cur_tileloop_tile, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
	SLEG_CONDVAR("cur_tileloop_tile", _cur_tileloop_tile, SLE_UINT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
	    ...
	    SLEG_VAR("company_tick_counter", _cur_company_tick_index, VarFileType::U8  | SLE_VAR_U32),
	...
	SLEG_CONDVAR("next_competitor_start", _new_competitor_timeout.period.value, VarFileType::U16 | SLE_VAR_U32, SaveLoadVersion::MinVersion, SaveLoadVersion::NextCompetitorStartOverflow),
...
static const SaveLoad _date_check_desc[] = {
	SLEG_CONDVAR("date", _load_check_data.current_date, VarFileType::U16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::BigDates),
...
static const SaveLoad _view_desc[] = {
	SLEG_CONDVAR("x", _saved_scrollpos_x, VarFileType::I16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
	SLEG_CONDVAR("x", _saved_scrollpos_x, SLE_INT32, SaveLoadVersion::MultipleRoadStops, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("y", _saved_scrollpos_y, VarFileType::I16 | SLE_VAR_I32, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
