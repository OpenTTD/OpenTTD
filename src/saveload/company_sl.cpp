...
static const SaveLoad _company_desc[] = {
	...
	SLE_CONDVAR(CompanyProperties, auto_loan,             SLE_BOOL,            SLV_AUTO_LOAN, SL_MAX_VERSION),
	SLE_CONDVAR(CompanyProperties, auto_loan_threshold,   SLE_INT64,           SLV_AUTO_LOAN, SL_MAX_VERSION),
