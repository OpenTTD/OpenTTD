...
static const SaveLoad _company_desc[] = {
	...
	SLE_CONDVAR(CompanyProperties, hidden_railtypes, SLE_UINT64, SLV_HIDDEN_AND_FAVOURITE_RRT_TYPES, SL_MAX_VERSION),
	SLE_CONDVAR(CompanyProperties, hidden_roadtypes, SLE_UINT64, SLV_HIDDEN_AND_FAVOURITE_RRT_TYPES, SL_MAX_VERSION),
	SLE_CONDVAR(CompanyProperties, favourite_railtypes, SLE_UINT64, SLV_HIDDEN_AND_FAVOURITE_RRT_TYPES, SL_MAX_VERSION),
	SLE_CONDVAR(CompanyProperties, favourite_roadtypes, SLE_UINT64, SLV_HIDDEN_AND_FAVOURITE_RRT_TYPES, SL_MAX_VERSION),
