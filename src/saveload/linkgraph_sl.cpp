...
struct LGRPChunkHandler : ChunkHandler {
	LGRPChunkHandler() : ChunkHandler(LabelToNum("LGRP"), ChunkType::Table) {}
...
struct LGRJChunkHandler : ChunkHandler {
	LGRJChunkHandler() : ChunkHandler(LabelToNum("LGRJ"), ChunkType::Table) {}
...
struct LGRSChunkHandler : ChunkHandler {
	LGRSChunkHandler() : ChunkHandler(LabelToNum("LGRS"), ChunkType::Table) {}
