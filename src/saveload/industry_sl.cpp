...
struct INDYChunkHandler : ChunkHandler {
	INDYChunkHandler() : ChunkHandler(LabelToNum("INDY"), ChunkType::Table) {}
...
struct IIDSChunkHandler : NewGRFMappingChunkHandler {
	IIDSChunkHandler() : NewGRFMappingChunkHandler(LabelToNum("IIDS"), _industry_mngr) {}
};

struct TIDSChunkHandler : NewGRFMappingChunkHandler {
	TIDSChunkHandler() : NewGRFMappingChunkHandler(LabelToNum("TIDS"), _industile_mngr) {}
};
...
struct IBLDChunkHandler : ChunkHandler {
	IBLDChunkHandler() : ChunkHandler(LabelToNum("IBLD"), ChunkType::Table) {}
...
struct ITBLChunkHandler : ChunkHandler {
	ITBLChunkHandler() : ChunkHandler(LabelToNum("ITBL"), ChunkType::Table) {}
