...
static std::array<PersistentStorage::ElementType, 16> _old_ind_persistent_storage;
...
static const SaveLoad _industry_desc[] = {
	...
	SLEG_CONDARR("storage", _old_ind_persistent_storage, SLE_UINT32, 16, SLV_76, SLV_161),
