...
static const SaveLoad _industry_desc[] = {
	...
	SLE_CONDVAR(Industry, random_colour,              SLE_FILE_U8 | SLE_VAR_U32,  SL_MIN_VERSION, SLV_RGB_CC),
	SLE_CONDVAR(Industry, random_colour,              SLE_UINT32,                 SLV_RGB_CC, SL_MAX_VERSION),
