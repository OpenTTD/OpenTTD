...
static const SaveLoad _cargomonitor_pair_desc[] = {
	SaveLoad::Variable<VarFileType::U32>("number", SLE_OBJECT_ADDRESS(TempStorage, number)),
	SaveLoad::Variable<VarFileType::U32>("amount", SLE_OBJECT_ADDRESS(TempStorage, amount)),
};
