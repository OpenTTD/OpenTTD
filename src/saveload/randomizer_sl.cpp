...
static const SaveLoad _randomizer_desc[] = {
	SaveLoad::Variable<VarFileType::U32>("state[0]", SLE_OBJECT_ADDRESS(Randomizer, state[0])),
	SaveLoad::Variable<VarFileType::U32>("state[1]", SLE_OBJECT_ADDRESS(Randomizer, state[1])),
};
