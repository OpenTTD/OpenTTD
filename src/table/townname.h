...
static const char* const _name_spanish_real[] = {
	...
	"Alcorc\xc3\xb3n",
	"San Crist\xc3\xb3bal de La Laguna",
	"Logroño",
	"Badajoz",
	"Salamanca",
	"Huelva",
	...
	"El Puerto de Santa Mar\xc3\xada",
	"Rivas-Vaciamadrid",
	"Melilla",
	...
	"Ciudad Real",
	"Gand\xc3\xada",
	"Santa Luc\xc3\xada de Tirajana",
	"Molina de Segura",
	"Majadahonda",
	"Paterna",
	"Benidorm",
	"Sanl\xc3\xbacar de Barrameda",
	"Torremolinos",
	"Estepona",
	"Benalm\xC3\xA1dena",
	"Villanueva y Geltr\xc3\xba",
	"Casteldefels",
	"Viladecans",
	"Sagunto",
	"Ferrol",
