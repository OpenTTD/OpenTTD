...
/*
	...
	MBR(   0, 0, 16,  80,  32, 0xA24, PAL_NONE,
	   STR_BRIDGE_NAME_WOODEN,               STR_BRIDGE_DESCRIPTION_RAIL_WOODEN,              STR_BRIDGE_DESCRIPTION_ROAD_WOODEN),

	MBR(   0, 0,  2, 112,  48, 0xA26, PALETTE_TO_STRUCT_RED,
	   STR_BRIDGE_NAME_CONCRETE,             STR_BRIDGE_DESCRIPTION_RAIL_CONCRETE,            STR_BRIDGE_DESCRIPTION_ROAD_CONCRETE),

	MBR(1930, 0,  5, 144,  64, 0xA25, PAL_NONE,
	   STR_BRIDGE_NAME_GIRDER_STEEL,         STR_BRIDGE_DESCRIPTION_RAIL_GIRDER_STEELE,       STR_BRIDGE_DESCRIPTION_ROAD_GIRDER_STEEL),

	MBR(   0, 2, 10, 168,  80, 0xA22, PALETTE_TO_STRUCT_CONCRETE,
	   STR_BRIDGE_NAME_SUSPENSION_CONCRETE,  STR_BRIDGE_DESCRIPTION_RAIL_SUSPENSION_CONCRETE, STR_BRIDGE_DESCRIPTION_ROAD_SUSPENSION_CONCRETE),

	MBR(1930, 3, 16, 185,  96, 0xA22, PAL_NONE,
	   STR_BRIDGE_NAME_SUSPENSION_STEEL,     STR_BRIDGE_DESCRIPTION_RAIL_SUSPENSION_STEEL,    STR_BRIDGE_DESCRIPTION_ROAD_SUSPENSION_STEEL),

	MBR(1930, 3, 16, 192, 112, 0xA22, PALETTE_TO_STRUCT_YELLOW,
	   STR_BRIDGE_NAME_SUSPENSION_STEEL,     STR_BRIDGE_DESCRIPTION_RAIL_SUSPENSION_STEEL,    STR_BRIDGE_DESCRIPTION_ROAD_SUSPENSION_STEEL),

	MBR(1930, 3,  7, 224, 160, 0xA23, PAL_NONE,
	   STR_BRIDGE_NAME_CANTILEVER_STEEL,     STR_BRIDGE_DESCRIPTION_RAIL_CANTILEVER_STEEL,    STR_BRIDGE_DESCRIPTION_ROAD_CANTILEVER_STEEL),
	...
	MBR(1995, 2, 16, 255, 320, 0xA28, PAL_NONE,
	   STR_BRIDGE_NAME_TUBULAR_STEEL,        STR_BRIDGE_DESCRIPTION_RAIL_TUBULAR_STEEL,       STR_BRIDGE_DESCRIPTION_ROAD_TUBULAR_STEEL),

	MBR(2005, 2, 32, 380, 512, 0xA28, PALETTE_TO_STRUCT_YELLOW,
	   STR_BRIDGE_NAME_TUBULAR_STEEL,        STR_BRIDGE_DESCRIPTION_RAIL_TUBULAR_STEEL,       STR_BRIDGE_DESCRIPTION_ROAD_TUBULAR_STEEL),

	MBR(2010, 2, 32, 510, 608, 0xA28, PALETTE_TO_STRUCT_GREY,
	   STR_BRIDGE_TUBULAR_SILICON,           STR_BRIDGE_DESCRIPTION_RAIL_TUBULAR_STEEL,       STR_BRIDGE_DESCRIPTION_ROAD_TUBULAR_STEEL)
};
