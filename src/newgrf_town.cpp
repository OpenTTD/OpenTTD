...
/* virtual */ uint32_t TownScopeResolver::GetVariable(uint8_t variable, [[maybe_unused]] uint32_t parameter, bool &available) const
{
	...
	switch (variable) {
		...
		/* Recent cargo received, by cargo label */
		//case 0x65: return TownHistoryHelper(this->t, static_cast<CargoLabel>(parameter), THIS_MONTH, &Town::SuppliedHistory::received);
