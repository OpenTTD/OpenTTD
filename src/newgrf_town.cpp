...
/* virtual */ uint32 TownScopeResolver::GetVariable(byte variable, uint32 parameter, bool *available) const
{
	switch (variable) {
		...
		case 0xBA: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].new_max);
		case 0xBB: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].new_max), 8, 8);
		case 0xBC: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].new_max);
		case 0xBD: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].new_max), 8, 8);
		case 0xBE: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].new_act);
		case 0xBF: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].new_act), 8, 8);
		case 0xC0: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].new_act);
		case 0xC1: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].new_act), 8, 8);
		case 0xC2: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].old_max);
		case 0xC3: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].old_max), 8, 8);
		case 0xC4: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].old_max);
		case 0xC5: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].old_max), 8, 8);
		case 0xC6: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].old_act);
		case 0xC7: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_PASSENGERS]].old_act), 8, 8);
		case 0xC8: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].old_act);
		case 0xC9: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : GB(ClampToU16(this->t->supplied[CargoSpec::default_map[CT_MAIL]].old_act), 8, 8);
		case 0xCA: return CargoSpec::default_map[CT_PASSENGERS] == CT_INVALID ? 0 : this->t->GetPercentTransported(CargoSpec::default_map[CT_PASSENGERS]);
		case 0xCB: return CargoSpec::default_map[CT_MAIL] == CT_INVALID ? 0 : this->t->GetPercentTransported(CargoSpec::default_map[CT_MAIL]);
