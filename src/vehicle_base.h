...
public:
	...
	Date date_of_last_service;          ///< Last calendar date the vehicle had a service at a depot.
	Date economy_date_of_last_service;  ///< Last economy date the vehicle had a service at a depot.
