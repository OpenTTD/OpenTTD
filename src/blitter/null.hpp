...
public:
	...
	void SetPixel(void *, int, int, RgbMColour) override {};
	void DrawRect(void *, int, int, RgbMColour) override {};
	void DrawLine(void *, int, int, int, int, int, int, RgbMColour, int, int) override {};
