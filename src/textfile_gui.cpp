...
void TextfileWindow::ConstructWindow()
{
	...
	this->GetWidget<NWidgetCore>(WID_TF_CAPTION)->SetStringTip(STR_TEXTFILE_README_CAPTION + std::to_underlying(this->file_type), STR_TOOLTIP_WINDOW_TITLE_DRAG_THIS);
