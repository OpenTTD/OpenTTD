...
bool ScriptInstance::LoadCompatibilityScript(std::string_view api_version, Subdirectory dir)
{
	...
	for (Searchpath sp : _valid_searchpaths) {
		...
		Debug(Facility::Script, Severity::Fatal, "Error compiling / running API compatibility script: {}", buf);
		return false;
	}
...
{
	Debug(Facility::Script, Severity::Fatal, "The script died unexpectedly.");
	this->is_dead = true;
	this->in_shutdown = true;
