...
#else
/**
 * Class that handles all economy date related (calculation) functions.
 * @api ai game
 *
...
public:
	...
	/**
	 * Create a ScriptEconomyDate instance.
	 * Use ScriptEconomyDate::GetDate to compose valid date values for a known year, month and day.
	 * @param date A number representing a date.
	 */
...
/**
 * Class that handles all calendar date related (calculation) functions.
 * @api ai game
 *
 * @note Months and days of month are 1-based; the first month of the
 *       year is 1 and the first day of the month is also 1.
...
public:
	...
	/**
	 * Create a ScriptCalendarDate instance.
	 * Use ScriptCalendarDate::GetDate to compose valid date values for a known year, month and day.
	 * @param date A number representing a date.
	 */
