...
public:
	 ...
	 * @pre ScriptCompanyMode::IsDeity().
	 */
	static bool CreateWithInfo(NewsType type, Text *text, ScriptCompany::CompanyID company, NewsReferenceType ref_type, SQInteger reference, StringID title, Text *additional_message1, Text *additional_message2);
};
