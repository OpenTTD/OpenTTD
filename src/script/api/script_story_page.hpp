...
public:
	...
	enum StoryPageElementType : uint8_t {
		SPET_TEXT = ::std::to_underlying(::StoryPageElementType::Text), ///< An element that displays a block of text.
		SPET_LOCATION = ::std::to_underlying(::StoryPageElementType::Location), ///< An element that displays a single line of text along with a button to view the referenced location.
		SPET_GOAL = ::std::to_underlying(::StoryPageElementType::Goal), ///< An element that displays a goal.
		SPET_BUTTON_PUSH = ::std::to_underlying(::StoryPageElementType::ButtonPush), ///< A push button that triggers an immediate event.
		SPET_BUTTON_TILE = ::std::to_underlying(::StoryPageElementType::ButtonTile), ///< A button that allows the player to select a tile, and triggers an event with the tile.
		SPET_BUTTON_VEHICLE = ::std::to_underlying(::StoryPageElementType::ButtonVehicle), ///< A button that allows the player to select a vehicle, and triggers an event with the vehicle.
	};
	...
	enum StoryPageButtonCursor : uint8_t {
		SPBC_MOUSE = std::to_underlying(::StoryPageButtonCursor::Mouse),
		SPBC_ZZZ = std::to_underlying(::StoryPageButtonCursor::Zzz),
		SPBC_BUOY = std::to_underlying(::StoryPageButtonCursor::Buoy),
		SPBC_QUERY = std::to_underlying(::StoryPageButtonCursor::Query),
		SPBC_HQ = std::to_underlying(::StoryPageButtonCursor::HQ),
		SPBC_SHIP_DEPOT = std::to_underlying(::StoryPageButtonCursor::ShipDepot),
		SPBC_SIGN = std::to_underlying(::StoryPageButtonCursor::Sign),
		SPBC_TREE = std::to_underlying(::StoryPageButtonCursor::Tree),
		SPBC_BUY_LAND = std::to_underlying(::StoryPageButtonCursor::BuyLand),
		SPBC_LEVEL_LAND = std::to_underlying(::StoryPageButtonCursor::LevelLand),
		SPBC_TOWN = std::to_underlying(::StoryPageButtonCursor::Town),
		SPBC_INDUSTRY = std::to_underlying(::StoryPageButtonCursor::Industry),
		SPBC_ROCKY_AREA = std::to_underlying(::StoryPageButtonCursor::RockyArea),
		SPBC_DESERT = std::to_underlying(::StoryPageButtonCursor::Desert),
		SPBC_TRANSMITTER = std::to_underlying(::StoryPageButtonCursor::Transmitter),
		SPBC_AIRPORT = std::to_underlying(::StoryPageButtonCursor::Airport),
		SPBC_DOCK = std::to_underlying(::StoryPageButtonCursor::Dock),
		SPBC_CANAL = std::to_underlying(::StoryPageButtonCursor::Canal),
		SPBC_LOCK = std::to_underlying(::StoryPageButtonCursor::Lock),
		SPBC_RIVER = std::to_underlying(::StoryPageButtonCursor::River),
		SPBC_AQUEDUCT = std::to_underlying(::StoryPageButtonCursor::Aqueduct),
		SPBC_BRIDGE = std::to_underlying(::StoryPageButtonCursor::Bridge),
		SPBC_RAIL_STATION = std::to_underlying(::StoryPageButtonCursor::RailStation),
		SPBC_TUNNEL_RAIL = std::to_underlying(::StoryPageButtonCursor::TunnelRail),
		SPBC_TUNNEL_ELRAIL = std::to_underlying(::StoryPageButtonCursor::TunnelElrail),
		SPBC_TUNNEL_MONO = std::to_underlying(::StoryPageButtonCursor::TunnelMono),
		SPBC_TUNNEL_MAGLEV = std::to_underlying(::StoryPageButtonCursor::TunnelMaglev),
		SPBC_AUTORAIL = std::to_underlying(::StoryPageButtonCursor::AutoRail),
		SPBC_AUTOELRAIL = std::to_underlying(::StoryPageButtonCursor::AutoElrail),
		SPBC_AUTOMONO = std::to_underlying(::StoryPageButtonCursor::AutoMono),
		SPBC_AUTOMAGLEV = std::to_underlying(::StoryPageButtonCursor::AutoMaglev),
		SPBC_WAYPOINT = std::to_underlying(::StoryPageButtonCursor::Waypoint),
		SPBC_RAIL_DEPOT = std::to_underlying(::StoryPageButtonCursor::RailDepot),
		SPBC_ELRAIL_DEPOT = std::to_underlying(::StoryPageButtonCursor::ElrailDepot),
		SPBC_MONO_DEPOT = std::to_underlying(::StoryPageButtonCursor::MonoDepot),
		SPBC_MAGLEV_DEPOT = std::to_underlying(::StoryPageButtonCursor::MaglevDepot),
		SPBC_CONVERT_RAIL = std::to_underlying(::StoryPageButtonCursor::ConvertRail),
		SPBC_CONVERT_ELRAIL = std::to_underlying(::StoryPageButtonCursor::ConvertElrail),
		SPBC_CONVERT_MONO = std::to_underlying(::StoryPageButtonCursor::ConvertMono),
		SPBC_CONVERT_MAGLEV = std::to_underlying(::StoryPageButtonCursor::ConvertMaglev),
		SPBC_AUTOROAD = std::to_underlying(::StoryPageButtonCursor::AutoRoad),
		SPBC_AUTOTRAM = std::to_underlying(::StoryPageButtonCursor::AutoTram),
		SPBC_ROAD_DEPOT = std::to_underlying(::StoryPageButtonCursor::RoadDepot),
		SPBC_BUS_STATION = std::to_underlying(::StoryPageButtonCursor::BusStation),
		SPBC_TRUCK_STATION = std::to_underlying(::StoryPageButtonCursor::TruckStation),
		SPBC_ROAD_TUNNEL = std::to_underlying(::StoryPageButtonCursor::RoadTunnel),
		SPBC_CLONE_TRAIN = std::to_underlying(::StoryPageButtonCursor::CloneTrain),
		SPBC_CLONE_ROADVEH = std::to_underlying(::StoryPageButtonCursor::CloneRoadVeh),
		SPBC_CLONE_SHIP = std::to_underlying(::StoryPageButtonCursor::CloneShip),
		SPBC_CLONE_AIRPLANE = std::to_underlying(::StoryPageButtonCursor::CloneAirplane),
		SPBC_DEMOLISH = std::to_underlying(::StoryPageButtonCursor::Demolish),
		SPBC_LOWERLAND = std::to_underlying(::StoryPageButtonCursor::LowerLand),
		SPBC_RAISELAND = std::to_underlying(::StoryPageButtonCursor::RaiseLand),
		SPBC_PICKSTATION = std::to_underlying(::StoryPageButtonCursor::PickStation),
		SPBC_BUILDSIGNALS = std::to_underlying(::StoryPageButtonCursor::BuildSignals),
	};
	...
	enum StoryPageButtonColour : uint8_t {
		SPBC_DARK_BLUE  = std::to_underlying(::Colours::DarkBlue),
		SPBC_PALE_GREEN = std::to_underlying(::Colours::PaleGreen),
		SPBC_PINK       = std::to_underlying(::Colours::Pink),
		SPBC_YELLOW     = std::to_underlying(::Colours::Yellow),
		SPBC_RED        = std::to_underlying(::Colours::Red),
		SPBC_LIGHT_BLUE = std::to_underlying(::Colours::LightBlue),
		SPBC_GREEN      = std::to_underlying(::Colours::Green),
		SPBC_DARK_GREEN = std::to_underlying(::Colours::DarkGreen),
		SPBC_BLUE       = std::to_underlying(::Colours::Blue),
		SPBC_CREAM      = std::to_underlying(::Colours::Cream),
		SPBC_MAUVE      = std::to_underlying(::Colours::Mauve),
		SPBC_PURPLE     = std::to_underlying(::Colours::Purple),
		SPBC_ORANGE     = std::to_underlying(::Colours::Orange),
		SPBC_BROWN      = std::to_underlying(::Colours::Brown),
		SPBC_GREY       = std::to_underlying(::Colours::Grey),
		SPBC_WHITE      = std::to_underlying(::Colours::White),
	};
