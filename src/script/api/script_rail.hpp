...
public:
	...
	enum SignalType {
		...
		SIGNALTYPE_NORMAL = std::to_underlying(::SignalType::Block), ///< Block signal.
		SIGNALTYPE_ENTRY = std::to_underlying(::SignalType::Entry), ///< Entry presignal.
		SIGNALTYPE_EXIT = std::to_underlying(::SignalType::Exit), ///< Exit signal.
		SIGNALTYPE_COMBO = std::to_underlying(::SignalType::Combo), ///< Combo signal.
		SIGNALTYPE_PBS = std::to_underlying(::SignalType::Path), ///< Normal path signal.
		SIGNALTYPE_PBS_ONEWAY = std::to_underlying(::SignalType::PathOneWay), ///< No-entry path signal.
