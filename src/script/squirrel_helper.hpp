 ...
 */
template <class CL, ScriptType ST> void PushClassName(HSQUIRRELVM vm);
...
namespace SQConvert {
	...
	/* We go via int32_t for unsigned types to account for code trying to use -1 as an unsigned value */
	template <> struct Return<uint8_t>      { static inline SQRESULT Set(HSQUIRRELVM vm, uint8_t res)     { sq_pushinteger(vm, (int32_t) res);        return SQ_RETURN; } };
	template <> struct Return<uint16_t>     { static inline SQRESULT Set(HSQUIRRELVM vm, uint16_t res)    { sq_pushinteger(vm, (int32_t) res);        return SQ_RETURN; } };
	template <> struct Return<uint32_t>     { static inline SQRESULT Set(HSQUIRRELVM vm, uint32_t res)    { sq_pushinteger(vm, (int32_t) res);        return SQ_RETURN; } };
	template <> struct Return<int8_t>       { static inline SQRESULT Set(HSQUIRRELVM vm, int8_t res)      { sq_pushinteger(vm, res);                  return SQ_RETURN; } };
	template <> struct Return<int16_t>      { static inline SQRESULT Set(HSQUIRRELVM vm, int16_t res)     { sq_pushinteger(vm, res);                  return SQ_RETURN; } };
	template <> struct Return<int32_t>      { static inline SQRESULT Set(HSQUIRRELVM vm, int32_t res)     { sq_pushinteger(vm, res);                  return SQ_RETURN; } };
	template <> struct Return<int64_t>      { static inline SQRESULT Set(HSQUIRRELVM vm, int64_t res)     { sq_pushinteger(vm, res);                  return SQ_RETURN; } };
	template <> struct Return<TileIndex>    { static inline SQRESULT Set(HSQUIRRELVM vm, TileIndex res)   { sq_pushinteger(vm, (int32_t) res.base()); return SQ_RETURN; } };
	template <> struct Return<bool>         { static inline SQRESULT Set(HSQUIRRELVM vm, bool res)        { sq_pushbool   (vm, res);                  return SQ_RETURN; } };
	...
	template <> struct Return<HSQOBJECT>    { static inline SQRESULT Set(HSQUIRRELVM vm, HSQOBJECT res)   { sq_pushobject(vm, res);                   return SQ_RETURN; } };
	...
	template <> struct Param<uint8_t>      { static inline uint8_t     Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<uint16_t>     { static inline uint16_t    Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<uint32_t>     { static inline uint32_t    Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<int8_t>       { static inline int8_t      Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<int16_t>      { static inline int16_t     Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<int32_t>      { static inline int32_t     Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<int64_t>      { static inline int64_t     Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return tmp; } };
	template <> struct Param<TileIndex>    { static inline TileIndex   Get(HSQUIRRELVM vm, SQInteger index) { SQInteger     tmp; sq_getinteger    (vm, index, &tmp); return TileIndex((uint32_t)(int32_t)tmp); } };
	template <> struct Param<bool>         { static inline bool        Get(HSQUIRRELVM vm, SQInteger index) { SQBool        tmp; sq_getbool       (vm, index, &tmp); return tmp != 0; } };
	...
	template <typename T> requires std::is_enum_v<T> struct Param<T> {
		static inline T Get(HSQUIRRELVM vm, SQInteger index)
		{
			SQInteger tmp;
	...
	template <> struct Param<const std::string &> {
		static inline const std::string Get(HSQUIRRELVM vm, SQInteger index)
		{
	...
	struct Param<Array<Titem> &&> {
		static inline Array<Titem> Get(HSQUIRRELVM vm, SQInteger index)
		{
	...
	inline SQRESULT DefSQAdvancedNonStaticCallback(HSQUIRRELVM vm)
	{
		...
		try {
			...
			auto cls_instance = static_cast<Tcls *>(real_instance);
			auto method = *static_cast<Tmethod *>(ptr);
			return static_cast<SQRESULT>((cls_instance->*method) (vm));
		} catch (SQRESULT &e) {
			return e;
		}
	}
	...
	inline SQRESULT DefSQAdvancedStaticCallback(HSQUIRRELVM vm)
	{
		...
		try {
			/* Call the function, which its only param is always the VM */
			auto method = *static_cast<Tmethod *>(ptr);
			return static_cast<SQRESULT>((*method) (vm));
		} catch (SQRESULT &e) {
			return e;
		}
	}
