...
/** @file settings_internal_gui.h Declarations of classes for handling display of individual configuration settings. */

#ifndef SETTING_INTERNAL_GUI_H
#define SETTING_INTERNAL_GUI_H
