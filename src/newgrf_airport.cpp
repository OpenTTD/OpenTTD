...
{
	AirportClass::Get(AirportClass::Allocate(LabelToNum("SMAL")))->name = STR_AIRPORT_CLASS_SMALL;
	AirportClass::Get(AirportClass::Allocate(LabelToNum("LARG")))->name = STR_AIRPORT_CLASS_LARGE;
	AirportClass::Get(AirportClass::Allocate(LabelToNum("HUB_")))->name = STR_AIRPORT_CLASS_HUB;
	AirportClass::Get(AirportClass::Allocate(LabelToNum("HELI")))->name = STR_AIRPORT_CLASS_HELIPORTS;
}
