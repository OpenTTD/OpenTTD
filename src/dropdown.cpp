 ...
 */
DropdownWindow::DropdownWindow(int window_id, Window *parent, DropDownList &&list, int selected, WidgetID button, const Rect wi_rect, bool instant_close, Colours wi_colour, bool persist, bool has_sorter, WindowDesc &window_desc)
	: Window(window_desc)
