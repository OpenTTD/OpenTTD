...
struct BuildRailToolbarWindow : Window {
	...
	static inline HotkeyList hotkeys{"railtoolbar", {
		...
		Hotkey({'5', 'A' | WKC_GLOBAL_HOTKEY, WKC_SHIFT | 'A' | WKC_GLOBAL_HOTKEY, WKC_ALT | 'A' | WKC_GLOBAL_HOTKEY}, "autorail", WID_RAT_AUTORAIL),
		...
		Hotkey({'S', WKC_SHIFT | 'S', WKC_ALT | 'S'}, "signal", WID_RAT_BUILD_SIGNALS),
