...
static WindowDesc _build_extended_depot_desc(__FILE__, __LINE__,
	WDP_AUTO, nullptr, 0, 0,
	WC_BUILD_DEPOT, WC_BUILD_TOOLBAR,
	WDF_CONSTRUCTION,
	std::begin(_nested_build_extended_depot_widgets), std::end(_nested_build_extended_depot_widgets)
);
