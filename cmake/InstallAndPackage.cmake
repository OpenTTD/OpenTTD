...
if(OPTION_INSTALL_FHS)
    cmake_path(SET BINARY_DESTINATION_DIR NORMALIZE "${CMAKE_INSTALL_BINDIR}")
    cmake_path(SET DATA_DESTINATION_DIR NORMALIZE "${CMAKE_INSTALL_DATADIR}/${BINARY_NAME}")
    cmake_path(SET DOCS_DESTINATION_DIR NORMALIZE "${CMAKE_INSTALL_DOCDIR}")
    cmake_path(SET MAN_DESTINATION_DIR NORMALIZE "${CMAKE_INSTALL_MANDIR}")
else()
    if(APPLE)
        cmake_path(SET BINARY_DESTINATION_DIR NORMALIZE "../MacOS")
    else()
        cmake_path(SET BINARY_DESTINATION_DIR NORMALIZE ".")
    endif()
    cmake_path(SET DATA_DESTINATION_DIR NORMALIZE ".")
    cmake_path(SET DOCS_DESTINATION_DIR NORMALIZE ".")
    cmake_path(SET MAN_DESTINATION_DIR NORMALIZE ".")
endif()
