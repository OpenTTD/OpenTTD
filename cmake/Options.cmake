...
function(set_options)
    ...
    option(OPTION_LIBRETRO "Build as a libretro core" OFF)
...
function(show_options)
    ...
    message(STATUS "Option Libretro - ${OPTION_LIBRETRO}")
...
function(add_definitions_based_on_options)
    ...
    if(OPTION_LIBRETRO)
        add_definitions(-DWITH_LIBRETRO)
        add_definitions(-DLIBRETRO_CORE_BUILD)
        set(LIBRETRO ON PARENT_SCOPE)
    endif()
