            ...
            if(ACTIVE)
                if("${LINE}" MATCHES "^	*[A-Za-z0-9_]* *[,=]")
                    ...
                    if(CMAKE_MATCH_3)
                        ...
                        string(APPEND ${PLACE_HOLDER} "\n${ADD_INDENT}${CMAKE_MATCH_1}${CMAKE_MATCH_2}${SPACES} = std::to_underlying(::${ENUM_NAME}::${CMAKE_MATCH_2}),${SPACES}${NO_INVALID_LINKS}")
                    else()
                        string(APPEND ${PLACE_HOLDER} "\n${ADD_INDENT}${CMAKE_MATCH_1}${CMAKE_MATCH_2}${SPACES} = std::to_underlying(::${ENUM_NAME}::${CMAKE_MATCH_2}),")
                    endif()
