...
3. **Check if the issue has been fixed** --- try to reproduce it using the latest `nightly` build of OpenTTD, available from https://www.openttd.org/en/
...
**IMPORTANT**: By submitting a patch, you agree to allow the project owners to license your work under the terms of the [GPL v2](LICENSE).
...
By contributing your code, you agree to license your contribution under the [GPL v2](LICENSE).
