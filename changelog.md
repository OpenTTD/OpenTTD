...
### 16.0-beta1 (2026-06-04)

Feature: Trains with an engine on the rear drive backwards when reversing (#15379)
Feature: Add worldgen setting for average height (#14989)
Feature: Allow to build buoys at (0x0) (#14983)
...
Add: Implement custom waypoint layouts by callback 24 (#15616)
Add: List 'Place object' in landscaping dropdown (#15609)
Add: Scoped enum support for scripts (#15536)
Add: Conditional order to test if a train is driving backwards (#15484)
Add: Support automatic detection of data from Atari's Transport Tycoon Deluxe re-release (#15483)
...
Add: EnumClassIndexContainer class (#15078)
...
Add: [Script] Framework to make selected native calls suspendable (#14762)
...
Change: Make ScriptTile::IsBuildableRectangle use a TileArea for iteration (#15375)
...
Change: Removing river tiles reduce local authority rating (#15180)
...
Change: Warn about undocumented enum members (#15075)
Change: Cmake options to customise doxygen warnings (#15071)
Change: Add support for next/previous/first/last road/tram type hotkeys (#15028)
Change: Add support for next/previous/first/last railtype hotkeys (#15028)
Change: Allow rocks on desert tiles (#14979)
Change: [Script] Include Array contents in script memory allocation total (#14954)
Change: [Script] Include PriorityQueue contents in script memory allocation total (#14954)
Change: [Script] Include ScriptList contents in script memory allocation total (#14954)
Change: [Script] ScripTiletList::[Add|Remove]Rectangle are now suspendable (#14943)
Change: [Script] ScriptList::AddList is now suspendable (#14943)
Change: [Script] ScriptList::[Remove|Keep][Top|Bottom] are now suspendable (#14943)
Change: [Script] ScriptList::[Remove|Keep][XXXValue|List] are now suspendable (#14943)
...
Change: Make dropdown text filter persistent in some cases (#14842)
Change: Enable dropdown text filter for various dropdown lists (#14842)
Change: Add text filter to dropdown lists (#14842)
...
Change: [Script] ScriptList::Valuate is now suspendable (#14762)
...
Fix: Finding nearest train depot when driving backwards (#15590)
...
Fix: Use tile of leading vehicle when calculating too-short station loading penalty (#15530)
...
Fix: Force proceed behaviour when driving backwards (#15510)
Fix: Condition for whether to change driving direction or flip on train reverse (#15499)
Fix #15497: [Script] ScriptController::Break not pausing in TestMode (#15498)
Fix: Prevent setting DrivingBackwards condition on non-trains (#15493)
...
Fix: Rejecting or accepting engine preview incorrectly closed preview windo (#15378)
Fix: Correct two non-continuation error messages (#15340)
...
Fix: MacOS version detection was broken, and return a tuple instead of three out-params (#15145)
