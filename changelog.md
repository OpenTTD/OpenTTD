...
- Fix: Properly handle picker window invalidation (#14816)
...
- Fix #14549: Changing interface scale could underflow map zoom (#14655)
...
- Fix: Game crash due to invalid vehicle type information (#14628)
...
- Fix: [AI] Incorrect infrastructure cost for road/tram tiles (#14596)
...
- Fix #14278: [Script] Don't set members inside operator new() (#14568)
